...
The gate peers the `@integraledger/lcp-*` protocol line as `^0.18.3`. Your package manager installs one
...
- **[Paying an x402 seller](/protocols/x402-payment)** — verified, and now served: the nonce is the
