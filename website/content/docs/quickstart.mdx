---
title: Quickstart
description: Install the guard, wire its ports, state a policy, and halt on a fingerprint that disagrees.
---
...
The guard peers the `@integraledger/lcp-*` protocol line as `^0.14.0`. Your package manager installs one
