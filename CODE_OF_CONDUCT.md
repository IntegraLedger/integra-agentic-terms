...
This project is the buyer-side reference implementation of the **Legal Context Protocol (LCP)**, which is
co-stewarded by Integra Ledger and AAA-ICDR. Contributors arrive from software, from legal practice, and
from standards work, and they will not share a professional culture. That is the reason to state
expectations plainly rather than assume them.
